...
<%@ page import="java.sql.ResultSet"%>
    ...
    <body style="background: url(img/profile.jpg); background-size:cover;background-attachment:fixed">
      <!-- Nav Bar -->
      <nav class="navbar navbar-dark bg-black">
        <div class="container">
          <span class="navbar-brand mb-0 h1"><img src="img/greet.gif" width="154" height="55"></span>
          <span style="padding-left:620px;">
            ...
            try {
               ...
               while(resultSet.next()){
                   if(resultSet.getString("userLoginId").equalsIgnoreCase(email)
                       ...
                       String userData = "select * from Party natural join UserLoginId where userLoginId = ?";
                           ...
                           <div class="modal-dialog">
                             <div class="modal-content">
                               ...
                               <div class="modal-body">
                                 <form style="align-items: center;" action="editprofile" method="post">
                                   <div class="col-md-12">
